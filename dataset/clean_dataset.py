...
before dropping the redundant _y features. It then removes all unique row identifiers and index flags (such as caseid, pidx, bidx, hidx, and idx92–idx96) 
...
It automatically detects and removes zero-sample features (columns with 100% missing values) as well as any sparse variables containing 70% or more missing values (NaN).
"""
